...
class CriticalRiskFlightsScreen extends StatelessWidget {
  const CriticalRiskFlightsScreen({super.key});
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: const Color(0xFF3A2627), // Critical risk background color
        ...
        child: Column(
          children: [
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        color: Color(0xFFF3745C), // Critical risk text color
                      ),
                    ),
                    const SizedBox(height: 4),
                    Text(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: const Color(
                    0xFF4A2F30), // Darker shade for status background
